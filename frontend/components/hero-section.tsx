...
export function HeroSection() {
  ...
  const slides = [
    ...
    {
      id: 2,
      image: "https://images.unsplash.com/photo-1556228453-efd6c1ff04f6?w=1920&h=1080&fit=crop&auto=format",
    ...
    {
      id: 3,
      image: "https://images.unsplash.com/photo-1517991104123-1d56a6e81ed9?w=1920&h=1080&fit=crop&auto=format",
    ...
    {
      id: 4,
      image: "https://images.unsplash.com/photo-1565814329452-e1efa11c5b89?w=1920&h=1080&fit=crop&auto=format",
    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-10">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center justify-center mb-6">
            <div className="flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
              ...
              <span className="text-sm font-medium">Premium Art Collection</span>
              <Sparkles className="w-5 h-5 text-terracotta animate-pulse" />
            </div>
          </div>

          <div key={currentSlide} className="mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <h1 className="mb-4 leading-tight text-4xl md:text-6xl font-bold">
              <span className="block text-white/90 mb-2">{slides[currentSlide].title}</span>
            ...
            <p className="text-xl md:text-2xl mb-2 text-white/90 leading-relaxed">{slides[currentSlide].accent}</p>
          </div>

          <div className="mb-10">
            <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed mb-6">
              Discover thousands of carefully curated posters from talented artists worldwide.
            </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-8">
            ...
            <Button
              ...
              className="group border-2 border-white/30 text-white hover:bg-white/10 px-10 py-6 text-lg font-semibold rounded-full"
            >
          ...
          <div className="grid grid-cols-3 gap-8 max-w-lg mx-auto mb-12">
            <div className="text-center">
              <div className="text-5xl font-bold text-transparent bg-gradient-to-b from-terracotta to-mustard bg-clip-text mb-2">10K+</div>
              <div className="text-sm text-white/80">Happy Customers</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-transparent bg-gradient-to-b from-mustard to-pastel-pink bg-clip-text mb-2">500+</div>
              <div className="text-sm text-white/80">Unique Designs</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-transparent bg-gradient-to-b from-pastel-pink to-terracotta bg-clip-text mb-2">50+</div>
        ...
        {slides.map((_, index) => (
          <button
            ...
            className={`relative w-3 h-3 rounded-full transition-all duration-300 ${
              index === currentSlide ? "bg-terracotta shadow-lg shadow-terracotta/50" : "bg-white/30 hover:bg-white/50"
            }`}
          >
            {index === currentSlide && (
      ...
      <div className="absolute top-6 right-6 z-20">
        <Button
          ...
          className="bg-black/20 hover:bg-black/40 text-white text-xs px-3 py-2 rounded-full backdrop-blur-sm border border-white/20"
        >
